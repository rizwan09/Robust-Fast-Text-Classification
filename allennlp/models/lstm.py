...
class SimpleLSTM(Model):
    ...
    def __init__(self,
        ...
        super(SimpleLSTM, self).__init__(vocab, regularizer)
    ...
    def forward(self,  # type: ignore
        ...
        time_needed = time.time() - tmp
        # print('encoded_tokens.size(): ', encoded_tokens.size())
        ...
        integrator_input = encoded_tokens
